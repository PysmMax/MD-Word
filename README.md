...
Надбавка (add-in) для Microsoft Word, яка додає вкладку **Markdown** з двома
кнопками: **Вставити Markdown** (перетворює буфер обміну/Markdown-текст на
...
1. Завантажте `MD-Word-Setup-<версія>.exe`.
